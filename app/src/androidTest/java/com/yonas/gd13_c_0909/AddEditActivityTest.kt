...
class AddEditActivityTest {
    ...
    fun addEditActivityTest() {
        ...
        textInputEditText.perform(scrollTo(), replaceText("Blasius Yonas Vikariandi"), closeSoftKeyboard())
        ...
        textInputEditText2.perform(scrollTo(), replaceText("200710909"), closeSoftKeyboard())
